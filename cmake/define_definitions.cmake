...
if(${QET_COMMON_COLLECTION_PATH} STRGREATER "")
  if(${QET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH})
    message("QET_COMMON_COLLECTION_PATH " ${QET_COMMON_COLLECTION_PATH} " (relative to binary path)")
...
if(${QET_COMMON_TBT_PATH} STRGREATER "")
  if(${QET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH})
    message("QET_COMMON_TBT_PATH        " ${QET_COMMON_TBT_PATH} " (relative to binary path)")
...
if(${QET_LANG_PATH} STRGREATER "")
  if(${QET_LANG_PATH_RELATIVE_TO_BINARY_PATH})
    message("QET_LANG_PATH              " ${QET_LANG_PATH} " (relative to binary path)")
